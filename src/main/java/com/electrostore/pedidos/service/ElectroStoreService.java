...
public class ElectroStoreService {
    ...
    public List<Producto> buscarStockBajo(Integer umbral) {
    ...
    public Pedido crearPedido(PedidoRequestDTO request) {
        ...
        if (montoTotalAcumulado.compareTo(new BigDecimal("1000.00")) > 0) {
            descuento = montoTotalAcumulado.multiply(new BigDecimal("0.10"));
            montoTotalAcumulado = montoTotalAcumulado.subtract(descuento);
        }
